...
Write down the IP address — it will look something like `192.168.1.45`.
...
Enter a Motorola System ID (1-6 hexadecimal characters) and click **Generate System Key File**.
